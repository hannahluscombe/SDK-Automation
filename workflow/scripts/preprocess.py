...
See following link for original code: 
https://github.com/OSeMOSYS/OSeMOSYS_GNU_MathProg/blob/master/scripts/preprocess_data.py
...
if __name__ == '__main__':
    ...
    if "snakemake" in globals():
        main(snakemake.params.data_format, snakemake.input.txt, snakemake.output.txt)
    else:
        if len(sys.argv) != 4:
